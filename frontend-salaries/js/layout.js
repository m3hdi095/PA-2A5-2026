...
function lancerTutoriel() {
  ...
  const etapes = _lang === 'en' ? [
    { titre: 'Welcome to UpcycleConnect !',   texte: 'Your staff space lets you create training sessions, manage articles and moderate community forums.', icone: 'fa-seedling'          },
    { titre: 'Formations',                    texte: 'Create and animate training sessions and workshops, after validation by a manager.',                   icone: 'fa-graduation-cap'    },
    { titre: 'Surveys',                       texte: 'Send surveys to the participants of your training sessions and events.',                               icone: 'fa-clipboard-question'},
    { titre: 'Planning',                      texte: 'Track your schedule of sessions and events at a glance.',                                              icone: 'fa-calendar-days'     },
    { titre: 'Moderation & advice',           texte: 'Moderate forums and publish advice and news for the community.',                                       icone: 'fa-shield-halved'     },
  ] : [
    { titre: 'Bienvenue sur UpcycleConnect !', texte: 'Votre espace salarié vous permet de créer des formations, gérer les conseils et modérer les forums.',  icone: 'fa-seedling'          },
    { titre: 'Formations',                     texte: 'Créez et animez des formations et ateliers, après validation par un responsable.',                     icone: 'fa-graduation-cap'    },
    { titre: 'Questionnaires',                 texte: 'Envoyez des questionnaires aux participants de vos formations et événements.',                        icone: 'fa-clipboard-question'},
    { titre: 'Planning',                       texte: 'Suivez d’un coup d’œil votre planning de sessions et d’événements.',                                   icone: 'fa-calendar-days'     },
    { titre: 'Modération & conseils',          texte: 'Modérez les forums et publiez des conseils et actualités pour la communauté.',                         icone: 'fa-shield-halved'     },
  ];
